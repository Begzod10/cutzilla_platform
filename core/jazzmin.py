JAZZMIN_SETTINGS = {
    ...
    "site_title": "cutzilla Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "cutzilla",
    ...
    "welcome_sign": "Welcome to the Cutzilla Admin",
    ...
    "icons": {
        ...
        "common.FAQ": "fas fa-question",

        "client": "fas fa-users",
        "client.ServiceRequest": "fas fa-list",
        "client.ServiceRequestPhoto": "fas fa-image",
        "client.Vehicle": "fas fa-truck",
        "client.VehiclePhoto": "fas fa-image",
